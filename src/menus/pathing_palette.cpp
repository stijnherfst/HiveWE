...
PathingPalette::PathingPalette(QWidget* parent, Brush*& active_brush, PathingMap& pathing_map, WorldUndoManager& world_undo)
	: Palette(parent, active_brush), pathing_map(pathing_map), brush(world_undo) {
	ui.setupUi(this);
